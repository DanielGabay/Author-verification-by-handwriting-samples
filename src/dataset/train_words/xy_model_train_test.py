...
IMG_SIZE = 120
N_CLASS = 11
model_name = "xy_11_trained_model_120_120"
...
def test_model(X_test, y_test):
	...
	for i, test_image in enumerate(X_test):
		...
		result = result[0].tolist().index(max_result)+1
...
if __name__ == '__main__':
	if len(sys.argv) < 2:
		...
		sys.exit(1)
	X = pickle.load(open("X_11_120_120.pickle", "rb"))
	y = pickle.load(open("y_11_120_120.pickle", "rb"))
	X = X.astype('float32')
	X = X / 255
